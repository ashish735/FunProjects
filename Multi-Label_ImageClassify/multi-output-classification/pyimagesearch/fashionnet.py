...
class FashionNet:
	...
	def build_category_branch(inputs, numCategories,
		...
		# dress is a dress regardless of whether it’s red, blue, green, black
		# we decide to throw away any color information and instead focus on the 
		# actual structural components in the image, ensuring our network does 
		# not learn to jointly associate a particular color with a clothing type
